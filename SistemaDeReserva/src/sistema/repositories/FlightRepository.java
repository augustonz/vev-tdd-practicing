...
//Ao longo do codigo aparece alguns caracteres especiais , como na linha 133 , é preciso ter cuidado com isso 
...
public class FlightRepository {
	...
	public String listFlights(Map<Integer,Flight> flights) {
		...
		if (flights.size()==0) return "Nenhum voo foi cadastrado at� agora\n";
