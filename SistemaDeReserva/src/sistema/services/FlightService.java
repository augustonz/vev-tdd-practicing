...
public class FlightService {
	...
	public void createMockFlights() {
		flightRepository.addFlight(new Flight("Jo�o Pessoa","Recife","01/01/2023","13:00",true,35.00,48));
		flightRepository.addFlight(new Flight("Bras�lia","S�o Paulo","21/02/2015","22:00",true,120.00,60));
		flightRepository.addFlight(new Flight("S�o Paulo","Rio de Janeiro","11/07/2002","00:00",true,40.00,12));
		flightRepository.addFlight(new Flight("Jo�o Pessoa","Rio de Janeiro","21/02/2015","07:00",true,500.00,42));
	}
