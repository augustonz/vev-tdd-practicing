...
public class ParticaoEquivalenciaTests {
	...
	public void searchFlightsByOriginTest() {
		assertTrue(
			searchFlightUtil(
				flightService.flightRepository.searchFlightsByOrigin("João Pessoa"), 
	...
	@SearchFlightsTest
	@DisplayName("Busca voos por data - Data inválida")
	...
	@SearchFlightsTest
	@DisplayName("Busca voos por quantidade de assentos disponíveis")
	...
	@SearchFlightsTest
	@DisplayName("Busca voos por quantidade de assentos disponíveis - Quantidade inválida")
	...
	@ListFlightsTest
	@DisplayName("Lista todos os voos - Nenhum voo disponível")
	...
	@DisplayName("Cancela todas as reservas de um usuário")
	...
	@CancelReservationTest
	@DisplayName("Cancela todas as reservas de um usuário - Usuário não possui reservas")
